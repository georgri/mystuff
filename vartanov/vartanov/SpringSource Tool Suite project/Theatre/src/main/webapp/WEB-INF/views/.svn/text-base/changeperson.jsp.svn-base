...
<html>
	...
	<body>
		...
		<form method="GET" action="/Theatre/tochangeperson">
		<div class = round>
		<table class = form>
			<input value="${person.id}" type="hidden" name="personId" />
			<tr>
				<td>Title: &nbsp; </td> 
				<td><input value="${person.firstName}" type="text" name="firstName" /></td> 
			</tr>
			<tr>
				<td>Duration: &nbsp; </td> 
				<td><input value="${person.lastName}" type="text" name="lastName" /></td> 
			</tr>
			<tr>
