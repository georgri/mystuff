...
<html>
	...
	<body>
		...
		<form method="GET" action="/Theatre/tochangetheatre">
		<div class = round>
		<table class = form>
			<input value="${theatre.id}" type="hidden" name="theatreId" />
			<tr>
				<td>Title: &nbsp; </td> 
				<td><input value="${theatre.title}" type="text" name="title" /></td> 
			</tr>
			<tr>
				<td>Address: &nbsp; </td> 
				<td><input value="${theatre.address}" type="text" name="address" /></td> 
			</tr>
			<tr>
