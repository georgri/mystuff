...
<html>
	<head>
		...
		<title>Registration. Enzet Theatres</title>
	...
	<body>
		...
		<form:form method="post" action="/Theatre/newregistration" commandName="registration">
		<div class = round>
		<table class = form>
			<tr>
				<td>Login: &nbsp; </td> 
			...
			<tr>
				<td colspan = 2><br /><input type="submit" value="Registrate" /></td>
			</tr>
		</table>
		</div>
		</form:form>
