...
<html>
	...
	<body>
		...
		<div class = round>
			Welcome to the website where you can buy tickets.<br /><br />
			See list of all <a href="<c:url value="/performances/" />">performances</a> or all <a href="<c:url value="/theatres/" />">theaters</a>.<br /><br />
			<a href="<c:url value="/date/" />">Search</a> shows by dates.
		</div>
