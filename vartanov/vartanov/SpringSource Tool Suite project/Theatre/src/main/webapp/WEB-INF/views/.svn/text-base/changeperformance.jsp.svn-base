...
<html>
	...
	<body>
		...
		<form method="GET" action="/Theatre/tochangeperformance">
		<div class = round>
		<table class = form>
			<input value="${performance.id}" type="hidden" name="performanceId" />
			<tr>
				<td>Title: &nbsp; </td> 
				<td><input value="${performance.title}" type="text" name="title" /></td> 
			</tr>
			<tr>
				<td>Duration: &nbsp; </td> 
				<td><input value="${performance.duration}" type="text" name="duration" /></td> 
			</tr>
			<tr>
				<td colspan = 2><br /><input type="submit" value="Change" /></td>
			</tr>
		</table>
		</div>
		</form>
